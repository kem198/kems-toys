import { DeviceOrientationSample } from './DeviceOrientationSample';
...
当ページでは端末方向イベントのうち、[DeviceOrientationEvent](https://developer.mozilla.org/ja/docs/Web/API/DeviceOrientationEvent) から得られる下記の角度を表示している。
...
- [pixi.js](https://www.npmjs.com/package/pixi.js?ref=vanillalist) ([MIT](https://github.com/pixijs/pixijs/blob/dev/LICENSE))
- [@pixi/react](https://www.npmjs.com/package/@pixi/react) ([MIT](https://github.com/pixijs/pixi-react/blob/master/LICENSE))
