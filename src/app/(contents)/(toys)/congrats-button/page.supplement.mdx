...
- [js-confetti](https://www.npmjs.com/package/js-confetti) ([MIT](https://github.com/loonywizard/js-confetti/blob/main/LICENSE))
- [emoji-regex](https://www.npmjs.com/package/emoji-regex) ([MIT](https://github.com/mathiasbynens/emoji-regex/blob/main/LICENSE-MIT.txt))
- [emoji-mart](https://www.npmjs.com/package/emoji-mart) ([MIT](https://github.com/missive/emoji-mart/blob/main/LICENSE))
